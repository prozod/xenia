...
const Form = ({ children, ...props }: IForm) => {
  return (
    <form
      {...props}
      className="z-10 flex flex-col bg-gradient-to-b from-primary-800 to-primary-900 border-[0.25px] border-white/10 bg-primary-900/60 px-12 py-12 rounded-md gap-2 drop-shadow-2xl min-w-[20vw] relative"
    >
      {children}
    </form>
  );
