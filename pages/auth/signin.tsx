				...
				>
					<Form onSubmit={handleSubmit}>
						...
						<small className="text-xs font-medium text-white/80 w-72 mb-4">
							Unfortunately, email and password accounts are currently not implemented,{" "}
							<strong className="font-bold text-red-400"> please use the Google authentication</strong> method. <br />{" "}
							Thank you!
						</small>
						<Form.Group>
							<Form.Input
