...
Navigation.ListWrapper = React.forwardRef<HTMLUListElement, Props>(function ListWrapper(props, ref) {
	let MenuAnimation = {}
...
Navigation.CTAWrapper = function CTAWrapper({ children }: { children: React.ReactNode }) {
	return (
		<motion.div
