...
function ArtistPage() {
  ...
  const mutation = useMutation<any, any, any>({
    mutationFn: (data) => postNewArtist(data),
  });
  ...
  const onFileSubmit = async (evt: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!parsedArtistInfo.success) {
      ...
      console.log("SUCCESS", parsedArtistInfo);
              ...
              >
                ...
                >
                  ...
                  <Form.Group>
                    ...
                    />
                    <Form.Label text="Artist name" htmlFor="artistname" />
                    {showError.message.length > 1 &&
                      showError.path[0] === "name" && (
                  ...
                  <Form.Group>
                    ...
                    <Form.Label text="Description" htmlFor="description" />
                    {showError.message.length > 1 &&
                      showError.path[0] === "description" && (
                        <span className="text-xs font-bold text-red-400 mb-4">
                          {showError.message}
                        </span>
                      )}
