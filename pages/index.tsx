...
const Hero = () => {
	...
	return (
		<div className="box flex flex-col items-start justify-center py-16 z-0 h-3/4">
			...
			>
				<motion.h1
					className="text-6xl font-bold leading-16"
					variants={item}
				>
					Album hoarder or just a simple music lover?
				</motion.h1>
				<motion.p
					className="leading-24 pt-2 text-white/60"
					variants={item}
				>
					Pick the next target for your collection, see what people are listening to these days
				</motion.p>
				<motion.div
					variants={item}
					className="relative flex gap-2 my-4"
				>
					<Button.FullGradient
						text="Explore albums"
						href="/albums"
